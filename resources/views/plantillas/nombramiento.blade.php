...
<header>
    ...
    <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path().'/img/cabecera.png')) }}" width="100%" height="100%"/>
</header>

<footer>
<!-- <img src="footer.png" width="100%" height="100%"/> -->
<img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path().'/img/pie.png')) }}" width="100%" height="100%"/>
</footer>
